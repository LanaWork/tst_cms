...
<div class='bold-line'></div>
    <div class='container' action="vendor/signin.php" method="post">
      <div class='window'>
        ...
        <div class='content'>
          ...
          <div><button class='ghost-round full-width'>Войти</button></div>
          <div class="subtitle"><a href="register.php">Зарегестрироваться</a>
          <?php
            if ($_SESSION['message']) {
